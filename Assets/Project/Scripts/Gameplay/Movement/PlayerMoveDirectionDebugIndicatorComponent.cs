...
namespace MP.Gameplay.Movement
{
    ...
    public sealed class PlayerMoveDirectionDebugIndicatorComponent : MonoBehaviour
    {
        [SerializeField] private bool showDebugDirection = true;
        [SerializeField, Min(0f)] private float length = 1.1f;
        [SerializeField, Min(0f)] private float headLength = 0.25f;
        [SerializeField, Min(0f)] private float headAngle = 28f;
        [SerializeField, Min(0f)] private float lineWidth = 0.055f;
